...
export default function App() {
  return (
    <>
      <div className="App">
        <header className="App-header m-0 px-1 supports-[backdrop]:backdrop-blur-md supports-[backdrop]:backdrop-brightness-125 ease-out duration-300 shadow shadow-black/50">
          <p className="flex px-4 sm:px-10 mx-2 text-center text-4xl font-bold tracking-wide">
            Portfolio
          </p>
          <nav className="dropdown dropdown-left flex flex-row flex-nowrap h-20 justify-evenly">
            <div
        ...
        <main>
          <section className="hero min-h-screen text-base-200">
          ...
          <section className="m-0 py-2 sm:py-5 h-full sm:min-h-full">
            <article
              className="sm:p-4 py-4 overflow-hidden flex flex-col sm:flex-row justify-around"
              id="project-bg"
            >
              <ProjectCard
                imgSrc={Weather_fc}
          ...
          <section className="skills flex w-full h-full sm:min-h-full mb-6 sm:my-9 sm:px-2 p-2 sm:place-content-center bg-opacity-25">
            <article className="flex flex-col flex-nowrap pb-2 sm:pb-6 sm:px-4 rounded-xl">
              <h2 className="mr-auto ml-auto p-2 sm:p-4 text-xl sm:text-3xl font-bold sm:tracking-wide uppercase underline underline-offset-4">
                Technical Skills
              </h2>
              <div className="skills-grid grid gap-4 sm:gap-6">
                <article className="skills-grid-element">
                  <h3 className="fade-delay p-1 sm:px-2 sm:py-1 uppercase font-bold font-sans sm:text-xl text-lg tracking-wide">
                    <span className="underline underline-offset-4">
                      Front-End Development
                    </span>{" "}
                    |{" "}
                    <span className="text-base no-underline uppercase font-semibold">
                      HTML . CSS . Tailwind . bootstrap{" "}
                    </span>
                  </h3>
                  <p className="fade-delay px-1 sm:px-2 sm:text-base text-sm tracking-wide">
                    Proficient in HTML5, CSS (bootstrap, tailwind), and
                    JavaScript for building user interfaces and interactive web
                    experiences.
                  </p>
                </article>
                <article className="skills-grid-element">
                  ...
                  <p className="fade-delay px-1 sm:px-2 sm:text-base text-sm tracking-wide">
                    Possessing a strong foundation in backend development
                    principles and eager to learn and grow.
                  </p>
                </article>
                <article className="skills-grid-element">
                  <h3 className="fade-delay p-1 sm:px-2 sm:py-1 uppercase font-bold font-sans sm:text-xl text-lg tracking-wide">
                  ...
                  <p className="fade-delay px-1 sm:px-2 sm:text-base text-sm tracking-wide">
                    ...
                    experience in object-oriented (Java) and procedural (C)
                    programming languages, allowing for efficient
                    problem-solving and code maintainability.
                  </p>
                </article>
                <article className="skills-grid-element">
                  <h3 className="fade-delay p-1 sm:px-2 sm:py-1 uppercase font-bold font-sans sm:text-xl text-lg tracking-wide">
                  ...
                  <p className="fade-delay px-1 sm:px-2 sm:text-base text-sm tracking-wide">
                    Possess a strong working knowledge of database design
                    principles, data modeling, and querying using SQL.
                  </p>
                </article>
                <article className="skills-grid-element">
                  <h3 className="fade-delay p-1 sm:px-2 sm:py-1 uppercase font-bold font-sans sm:text-xl text-lg tracking-wide">
                  ...
                  <p className="fade-delay px-1 sm:px-2 sm:text-base text-sm tracking-wide">
                    Experience with Git forversion control, collaboration and
          ...
          <section className="flex flex-col education max-w-full text-base-200 px-4 py-8 sm:p-8 sm:place-items-center gap-2 sm:gap-4">
            <h2 className="block text-xl sm:text-3xl font-semibold underline underline-offset-4 tracking-wide uppercase">
              Educational Qualifications
            </h2>
            <article className="education-grid grid md:grid-cols-2 grid-cols-1 place-content-center gap-2">
              <div className="fade-delay p-2 sm:p-4 bg-white/5 rounded-md">
                <p className="px-2 text-base sm:text-xl font-medium">
                  University of Calicut
                </p>
                <p className="px-2 py-0 text-sm sm:text-lg font-sans">
                  Bachelor of Science, Mathematics
                  <span className="flex clear-left text-xs sm:text-sm text-white/75">
                    2020 - 2023
                  </span>
                </p>
              </div>
          ...
          <section className="contacts flex bottom-0 px-1 sm:px-4 py-3 sm:py-4 flex-row flex-nowrap align-middle justify-evenly sm:gap-2">
            <h2
              className="p-2 sm:text-xl text-base font-semibold underline underline-offset-4 sm:tracking-wide uppercase clear-right"
              id="contact"
            >
              Contacts
            </h2>
